                        ...
                        <div class="row">
                            @foreach($services as $service)
                              <div class="col-sm-6 col-xl-3" 
                                    ...
                                    data-bs-target="#serviceQuestionsModal"
                                    wire:click="showServiceQuestions({{ $service->id }})">

                                    <!-- Simple card -->
                                    <div class="card d-block">
                                        <img class="card-img-top rounded-top" src="{{asset('assets/images/small/img-1.jpg')}}" alt="Card image cap">
                                        <div class="card-body">
                            ...
                            @endforeach
                               ...
                               <!-- Modal -->
                                <div wire:ignore.self class="modal fade" data-bs-backdrop="static" id="serviceQuestionsModal" tabindex="-1" aria-labelledby="serviceQuestionsModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @if(count($questions))
                                                                                ...
                                                                                <div class="form-check">
                                                                                    {{-- <input type="checkbox" class="form-check-input" id="checkmeout0-{{$option->id}}"> --}}
                                                                                        @if($questions[$currentIndex]->mode === 'radio')
                                                                                            <input type="radio" wire:model="answers.{{ $questions[$currentIndex]->id }}" 
                                                            ...
                                                            <div class="d-flex justify-content-between mt-4">
                                                                <button class="btn btn-outline-secondary" wire:click="prevQuestion" @if($currentIndex === 0) disabled @endif>
                                                                    ‹ Previous
                                                                </button>
                                                                @if($currentIndex === count($questions) - 1)
                                                                    <button wire:click="submitAnswers" class="btn btn-success">Submit</button>
                                                                @else
                                                                    <button wire:click="nextQuestion" class="btn btn-outline-primary">Next  ›</button>
                                                                @endif
